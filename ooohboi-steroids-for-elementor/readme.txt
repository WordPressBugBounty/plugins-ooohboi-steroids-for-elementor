...
= 2.1.25 =
- Compatibility : Compatibility with WordPress 7.0
...
= 2.1.23 =
- Improvement : GLIDER : Compatibility with Elementor caching
- Improvement : HOVERANIMATOR : Compatibility with Elementor caching
- Improvement : PSEUDO : Compatibility with Elementor caching
- Improvement : SPACERAT : Compatibility with Elementor caching
- Fix : GLIDER : Glider slider not working with carousel
- Fix : Minor Bug Fixes & Performance Improvements
...
= 2.1.19 =
- Compatibility : Remove the Deprecated class of the Elementor
- Fix : Glider : Glider not working in the Theme 2025
- Fix : Minor Bug Fixes & Performance Improvements

= 2.1.17 =
- Added : IMBOX [Explanation Video](https://www.youtube.com/watch?v=qCnalXujsKI)
- Added : KONTROLZ [Explanation Video](https://www.youtube.com/watch?v=3y72JAvYAp4)
- Added : PHOTOMORPH [Explanation Video](https://www.youtube.com/watch?v=h2tSgoahK7s)
- Added : WIDGET STALKER [Explanation Video](https://www.youtube.com/watch?v=lkUoiiQQSk4)
- Added : CONTAINER EXTRAS [Explanation Video](https://www.youtube.com/watch?v=sCrg7Clp-Ow)
- Fix : Minor Bug Fixes & Performance Improvements

= 2.1.16 =
- Fix : Removes Unused CSS by adding conditions
- Fix : Elementor Top Bar is Overlaying
- Fix : Minor Bug Fixes & Performance Improvements
